...
class ScreenDetailCluster extends Component {
  constructor (props) {
    super(props)
    this.state = {
    ...
    return (
      <Container style={{ backgroundColor: '#fff' }}>
              ...
              <List
                ...
                renderRow={data =>
                  <ListItem thumbnail>
                    ...
                    <Right>
                      <Button transparent onPress={() => this.props.navigation.navigate('ScreenListUnits')}>
                        <Text>Select</Text>
                      </Button>
                    </Right>
                  </ListItem>}
        ...
        <View style={{ height: 80, width: '100%', borderColor: '#cdcdcd', borderTopWidth: 2 }}>
          <Grid>
            <Col style={{ padding: 5, justifyContent: 'center' }}>
              <Button onPress={() => this.props.navigation.navigate('ScreenListUnits')} style={{ justifyContent: 'center' }}><Text>View All Units</Text></Button>
            </Col>
            <Col style={{ padding: 5, justifyContent: 'center' }}>
              <Button onPress={() => this.props.navigation.navigate('ScreenMapLayout')} style={{ justifyContent: 'center' }}><Text>View Map</Text></Button>
            </Col>
          </Grid>
        </View>
      </Container>
...
export default ScreenDetailCluster
